...
const allservices = [
  ...
  { id: 2, title: "Botox", image: botox4, path: "/services/botox" },
  {
    ...
    image: facial1,
    path: "/services/facial-service",
  },
  {
    id: 4,
    title: "Gua Sha Massage",
    image: guasha1,
    path: "/services/gua-sha-massage",
  },
  {
    id: 5,
  ...
  },
  {
    ...
    title: "Calcium Peels",
    image: calciumpeel1,
    path: "/services/calciumpeels",
  },
  {
    id: 18,
    title: "Dermamelan",
    image: dermemelan,
    path: "/services/dermamelan",
  },
  {
    id: 19,
    title: "Fruit acid peeling",
    image: fruitpeel1,
    path: "/services/fruitpeeling",
  },
  {
    id: 20,
  ...
  },
  {
    ...
    title: "TriPollar(RF)",
    image: tripollar1,
    path: "/services/TriPollar",
  },
  /* {
    id: 22,
    title: "Dermal Filler",
    image: dermalfiller1,
    path: "/services/DermalFiller",
  },
  ...
  return (
    <div className="custom-container">
      ...
      <p className="custom-p">
        Non-Surgical Cosmetic Procedures There’s no denying that plastic surgery
        procedures are a big step in changing or enhancing your appearance. You
        may want to change your look, but not undergo surgery, and that’s
        perfectly understandable. Surgery isn’t for everyone. In addition,
        non-surgical cosmetic procedures are appealing because they require
        little to no downtime, present very low risk of complications, and can
        often be more affordable than surgery while still offering the kind of
        results you’re seeking. Whether you want to minimize the signs of aging
        with high-quality dermal fillers, give up shaving your legs with laser
        hair removal, you have several non-surgical cosmetic procedures
        available to you, and we offer many of them right here at
        <span className="font-bold">
          {" "}
          Maria Cosmetic Center (MCC). If, after reading about our non-surgical
